...
if (isset($_GET['type'])) {
    ...
    if (isset($_POST["search_text"]))
    {
        ...
        $query = "SELECT * FROM products where brand like '%$var%' ";
    }
    else
    {
...
if (isset($_GET['action'])) 
{
    ...
    elseif ($_GET['action'] == "remove" && isset($_GET['name'])) 
    {
        $productId = $_GET['name'];
...
<!DOCTYPE html>
<html>
    <head><title>Apex Rentals</title></head>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            while ($row = mysqli_fetch_array($result)) {?>
                                <div class="col-md-4">
                                    <form method="POST" action="products.php?name=<?=$row['name'] ?>">
                                
                                        <img src="/assignment2/Apex Rentals/assets/img/<?= $row['image'] ?>" style='height: 150px;'>
                                        <h5><?= $row['name']; ?></h5>
                                        ...
                                        <input type="number" name="stock" value="1" class="form-stock">
